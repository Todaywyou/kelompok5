  ...
  const items = [
    {
      ...
      image: "/jajanan.jpg", // CUKUP dari root /public
    },
    {
    ...
    <section className="px-6 py-16 bg-gradient-to-b from-white via-orange-50 to-red-50">
      <div className="max-w-4xl mx-auto text-center mb-12">
        ...
        <p className="text-lg text-orange-800">
          Kantin HMJ MI menghadirkan jajanan lezat, perlengkapan kuliah, dan
          layanan print berkualitas untuk mendukung aktivitasmu setiap hari.
        </p>
      </div>
      ...
      <div className="mt-14 text-center">
        <p className="text-lg text-orange-900 font-semibold">
          Nikmati kemudahan, kenyamanan, dan layanan terbaik hanya di Kantin HMJ
          MI. Semua kebutuhanmu, satu tempat penuh kehangatan!
        </p>
      </div>
    </section>
  );
